...
TRANSLATIONS = {
    "de": {
        ...
        "arm_arcana_wish_tooltip": "Arcana-Wunsch (nur Planung, kein echter Bonus)",
    ...
    "ru": {
        ...
        "arm_arcana_wish_tooltip": "Желаемый уровень Arcana (только планирование, не реальный бонус)",
    ...
    "en": {
        ...
        "arm_arcana_wish_tooltip": "Arcana wish (planning only, not a real bonus)",
