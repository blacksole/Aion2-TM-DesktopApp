...
class CustomTimerDialog(QDialog):
    def __init__(self, name: str = "", color: str = "",
        ...
        self.daily_time.setMinimumWidth(110)
        ...
        self.weekly_time.setMinimumWidth(110)
        ...
        self.hourly_time.setMinimumWidth(110)
        ...
        self.hourly_start_time.setMinimumWidth(110)
        ...
        self.custom_start_time.setMinimumWidth(110)
